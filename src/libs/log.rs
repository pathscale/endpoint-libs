...
use {
    tracing_appender::rolling::RollingFileAppender, tracing_subscriber::fmt,
    tracing_subscriber::prelude::__tracing_subscriber_SubscriberExt, tracing_subscriber::registry,
...
fn _setup_logs_internal<L, S: tracing::Subscriber>(
    _log_level: LogLevel,
    _log_dir_and_file_prefix: Option<(PathBuf, &str, Option<LogLevel>)>,
...
where
    L: Layer<S>,
{
    todo!("Reduce duplicated code across above functions and error aggregation versions")
}
